...
const getNames = (arr) => arr.map(currentValue => currentValue.name.split('').reverse().join(''));
// solution assistance for join() from https://stackoverflow.com/questions/1611427/reversing-a-string-in-javascript
